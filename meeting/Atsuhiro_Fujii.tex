...
\section{進捗状況}
ホームページ改修に関して，技術選定と環境構築に時間を取られまして，今週は進捗少なめです．
あとは書いていくだけかと思いますので，年内には仕上がると思います．

\subsection{脈波}
やはりWatch3では値が取得できません．
並行して別の指標を試すのを始めていきます．

\subsection{水量推定}
色々精度が上がる手法を探ってみました．
12次元のMFCCで3層CNNが良さそうです．
128次元のMFCCなども試しましたが，精度があまり変わりませんでした．
VGGでは深すぎて精度が下がりました．
今週，データの再収集をします．
