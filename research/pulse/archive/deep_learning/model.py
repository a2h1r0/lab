...
class Pix2Pix(nn.Module):
    ...
    class Generator(nn.Module):
        ...
        def __init__(self, kernel_size):
            ...
            self.relu6 = nn.LeakyReLU(negative_slope=0.01, inplace=True)
            ...
            self.relu7 = nn.LeakyReLU(negative_slope=0.01, inplace=True)
            ...
            self.relu8 = nn.LeakyReLU(negative_slope=0.01, inplace=True)
            ...
            self.relu9 = nn.LeakyReLU(negative_slope=0.01, inplace=True)
