...
SOUND_DIR = '../sounds/'
SOUND_FILE = 'shampoo_1.m4a'  # 音源


# ファイルの読み出し
sound = AudioSegment.from_file(SOUND_DIR + 'raw/' + SOUND_FILE, 'm4a')
...
# 分割
chunks = split_on_silence(sound, min_silence_len=2000, silence_thresh=-55)
