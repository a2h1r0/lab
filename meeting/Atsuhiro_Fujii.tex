...
\section{進捗状況}
論文誌の修正しました．最終チェックをお願いします．

\subsection{脈波}
進捗なしです．

\subsection{水量推定}
まず1つの入れ物で精度を上げるということですが，今北海道にいるので，とりあえず現在のデータセットで精度を上げていきます．
交差検証するようにしました．予測結果が100で張り付いており，精度がおかしかったので，改善．現在計算中です．

\subsection{BentoChallenge}
LSTM実装中．繰り返し動作の扱いと被験者の扱いは？バッチ処理？ここが微妙なので，再度議論したいです．
今週には計算できるようにして，とりあえず精度が悪くとも結果を出せる状態にして，論文に手を入れていきたいと思っています．
