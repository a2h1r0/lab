...
USE_COLUMNS = [
    'device_time_stamp', 'left_gaze_point_in_user_coordinate_system_1', 'left_gaze_point_in_user_coordinate_system_2', 'left_gaze_point_in_user_coordinate_system_3', 'left_pupil_diameter', 'left_gaze_origin_in_user_coordinate_system_1', 'left_gaze_origin_in_user_coordinate_system_2', 'left_gaze_origin_in_user_coordinate_system_3', 'right_gaze_point_in_user_coordinate_system_1', 'right_gaze_point_in_user_coordinate_system_2', 'right_gaze_point_in_user_coordinate_system_3', 'right_pupil_diameter', 'right_gaze_origin_in_user_coordinate_system_1', 'right_gaze_origin_in_user_coordinate_system_2', 'right_gaze_origin_in_user_coordinate_system_3'
]   # 特徴量
