...
//                データの取得開始
    ...
    protected void onResume() {
        super.onResume();
        mSensorManager.registerListener(this, mSensorManager.getDefaultSensor(mTypeHeartRate), SensorManager.SENSOR_DELAY_UI);
        mSensorManager.registerListener(this, mSensorManager.getDefaultSensor(mTypeRawPPG), SensorManager.SENSOR_DELAY_UI);
    }
