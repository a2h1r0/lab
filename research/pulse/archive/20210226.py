...
def plot_pulse_csv(file_dir, max_epoch, step, savefig=True):
    ...
    for index in range(len(t)):
        ...
        if savefig:
            plt.savefig('../figures/' + file_dir.split('/')[-1] + '_' + str(len(t[index])) + '_' + epoch + 'epoch.png',
...
if __name__ == '__main__':
    ...
    plot_colors_csv('./data/20210225_222004',
                    max_epoch=10000, step=1000, savefig=False)

    plot_loss_csv('./data/20210225_222004')
