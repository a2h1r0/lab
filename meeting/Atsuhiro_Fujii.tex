...
\subsection{脈波}
評価実験一通り終わりました．AppleWatchでもPC内蔵ディスプレイを除いてそれっぽい値が取れたので，解析して論文にしていきます．
まだフレキシブルディスプレイが試していないので，一度試して，微妙であればとりあえず論文から仕上げようと思います．（図もまだなので）

\subsection{水量推定}
パワースペクトルを見るプログラムは書きました．
まだデータの類似性を見れていないのですが，データ長を同じに正規化した上で，1秒のウィンドウ上でのユークリッド距離などを求め，類似性があるか確認するとかでいいでしょうか．
