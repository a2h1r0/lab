...
% Data acquisition begins when a user puts on the helmet. The voltage values of all pressure sensors are almost 5V when the helmet is not worn, and the voltage decreases when the helmet is worn. Data from 32 pressure sensors $\bm{p}(t)=[p_1(t),\cdots,p_{32}(t)]$ are acquired at time $t$, and the system segments the data over a 2-s window starting from $t=T_s$. Time $t=T_s$ is the time at which the change of the sum of 32 dimensions per sample $\sum_{i=1}^{32}(p_i(t)-p_i(t-1))$ is less than 1V for 11 consecutive samples (11/30 s), that is, $\sum_{i=1}^{32}(p_i(t)-p_i(t-1))<1[V]~(t=T_s,\cdots,T_s-10)$. The average value over the window $x_i(t)=\frac{1}{N}\sum_{t=T_S}^{T_S+N-1}p_i(t)$ for sensor channel $i$ ($i=1,\cdots,32)$ is calculated, where $N$ is the number of samples in the window. We then obtain a 32-dimensional vector $\bm{x}(t)=[x_{1}(t),\dots,p_{32}(t)]$ as a feature.
...
\centering
  ...
  \begin{tabular}{l|c} \hline\hline
    ...
    \textcolor{blue}{32 sensors} & 1.000 \\
    \textcolor{blue}{31 sensors} & 1.000 \\
    \vdots & \vdots \\
    \textcolor{blue}{5 sensors} & 1.000 \\
    $\#$0, $\#$3, $\#$5, $\#$16 & 0.994 \\
    $\#$3, $\#$11, $\#$24       & 0.972 \\
    $\#$3, $\#$25               & 0.922 \\
    $\#$10                      & 0.617 \\ \hline
  ...
  \begin{tabular}{l|c} \hline\hline
    Sensors used & Accuracy \\ \hline
    \textcolor{blue}{20 sensors} & 1.000 \\
    \textcolor{blue}{19 sensors} & 1.000 \\
    \vdots & \vdots \\
    \textcolor{blue}{5 sensors} & 1.000 \\
    $\#$0, $\#$3, $\#$5, $\#$16 & 0.994 \\
    $\#$0, $\#$3, $\#$13        & 0.983 \\
